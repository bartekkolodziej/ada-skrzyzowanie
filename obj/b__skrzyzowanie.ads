...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_skrzyzowanie" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1aa2fca9#;
   pragma Export (C, u00001, "skrzyzowanieB");
   ...
   u00137 : constant Version_32 := 16#7551e8e1#;
   pragma Export (C, u00137, "ada__synchronous_task_controlB");
   u00138 : constant Version_32 := 16#7f05aaa4#;
   pragma Export (C, u00138, "ada__synchronous_task_controlS");
   ...
   u00150 : constant Version_32 := 16#679d4f55#;
   pragma Export (C, u00150, "ada__task_identificationB");
   u00151 : constant Version_32 := 16#9ab4cdfa#;
   pragma Export (C, u00151, "ada__task_identificationS");
   u00152 : constant Version_32 := 16#70d5a0df#;
   pragma Export (C, u00152, "system__tasking__utilitiesB");
   u00153 : constant Version_32 := 16#332a5557#;
   pragma Export (C, u00153, "system__tasking__utilitiesS");
   u00154 : constant Version_32 := 16#ff0ade79#;
   pragma Export (C, u00154, "system__tasking__initializationB");
   u00155 : constant Version_32 := 16#f7885a93#;
   pragma Export (C, u00155, "system__tasking__initializationS");
   u00156 : constant Version_32 := 16#f29e7e8b#;
   ...
   u00170 : constant Version_32 := 16#927a893f#;
   pragma Export (C, u00170, "ada__text_ioB");
   u00171 : constant Version_32 := 16#25015822#;
   pragma Export (C, u00171, "ada__text_ioS");
   u00172 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00172, "interfaces__c_streamsB");
   u00173 : constant Version_32 := 16#b1330297#;
   pragma Export (C, u00173, "interfaces__c_streamsS");
   u00174 : constant Version_32 := 16#ec083f01#;
   pragma Export (C, u00174, "system__file_ioB");
   u00175 : constant Version_32 := 16#95d1605d#;
   pragma Export (C, u00175, "system__file_ioS");
   u00176 : constant Version_32 := 16#cf3f1b90#;
   pragma Export (C, u00176, "system__file_control_blockS");
   u00177 : constant Version_32 := 16#006dadc7#;
   pragma Export (C, u00177, "nt_consoleB");
   u00178 : constant Version_32 := 16#9a1dee7a#;
   pragma Export (C, u00178, "nt_consoleS");
   ...
   u00181 : constant Version_32 := 16#0fc99b06#;
   pragma Export (C, u00181, "system__tasking__rendezvousB");
   u00182 : constant Version_32 := 16#f242aaf9#;
   ...
   u00187 : constant Version_32 := 16#5dc07a5a#;
